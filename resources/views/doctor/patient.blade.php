                            ...
                            <table class="table table-striped table-inverse table-responsive-sm text-center" id="example">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        ...
                                        <td>
                                        <a href="/doctor/patient/{{$patient->id}}/details" class="btn btn-sm"  style="font-weight:400; background-color:#336699; color:white; text-decoration:none">Patient's Detail</a>
                                        </td>
                                        <td>
                                            <button type="button"  class="btn view btn-primary btn-sm" data-toggle="modal" data-target="#modelId" data-id="{{$patient->id}}" style="font-weight:400; background-color:#336699; "> Run Diagnosis</button>
                                        </td>
                                        <td>
                                            <a href="/doctor/patient/{{$patient->id}}/diagnosis/view" class="btn view btn-sm btn-primary">View All Diagnosis</a>
                                        </td>
