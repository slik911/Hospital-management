                    ...
                    <table class="table table-striped table-inverse table-responsive-sm text-center" id="example">
                        <thead class="thead-inverse">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <a href="/doctor/appointment/{{$booking->id}}/approve" class="btn btn-sm btn-primary" style="background-color:#336699; color:white">Approve</a>
                                </td>
                                <td>
                                <a href="/doctor/appointment/{{$booking->id}}/delete" class="btn btn-sm btn-primary" style="background-color:#336699; color:white">Delete</a>
                                </td>
                                </tr>
                                @endforeach
                            </tbody>
