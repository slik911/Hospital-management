    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="row">
                <div class="col-md-6">
                        <div class="col-md-12">
                                <a href="/clerk/patient" style="text-decoration:none">
                                    <div class="card mb-3">
                        ...
                        <div class="col-md-12">
                                <a href="/clerk/appointment" style="text-decoration:none">
                                    <div class="card mb-3">
                                        <div class="card-body  p-5 text-center bg-primary text-white">
                                             <i class="fas fa-calendar-alt fa-5x"></i>
                                        <h1 style="font-weight:400">{{$app}} Approved Appointments</h1>
                                        </div>
                                    </div>
                                    </a>
                        </div>
