...
<head>
    ...
    <title>Hospital Management|Clerk</title>
...
<body>
    <div id="app">
            <nav class="navbar navbar-expand-sm navbar-dark " style="background:#336699;">
                <div class="container">
                        <a class="navbar-brand" href="/clerk">Hospital</a>
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="/clerk/patient">
                            Patients
                        </a>
                        </li>

                        <li class="nav-item">
                                <a class="nav-link" href="/clerk/appointment">
                                    Appointments
                                </a>
                                </li>
                        </ul>
                          ...
                          <ul class="navbar-nav ml-auto">
                            ...
                            {{-- <li class="nav-item">
                              <a class="nav-link" href="#">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/clerk/profile">
                                       Profile
                                    </a>
                                </li>
